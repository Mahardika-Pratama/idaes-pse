"""
Example 8.2 in Seider's Product and Process Design Principles : Synthesis, Analysis, and Evaluation 4th Edition.
reaction property package for the hydrodealkylation of
